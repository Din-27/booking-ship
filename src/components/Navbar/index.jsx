...
import OptionIcon from '../../assets/Vector.svg'

export default function index() {

    return (
        <header className="fixed top-0 w-full p-2 bg-gradient-to-b from-black/45 from-60% z-20">
            <LayoutScreen>
                    ...
                    <div className="md:flex md:items-center md:gap-12">
                        <nav aria-label="Global" className="md:block">
                            <ul className="flex items-center gap-6 text-sm">
                                <li>
                                    <a className="text-white transition hover:text-white/75" href="#"> Sign up </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                </div>
                <div className="lg:flex h-16 items-center justify-between hidden">
                    <div className="flex-1 md:flex md:items-center md:gap-12">
                        <a className="block text-white" href="#">
                            <span className="sr-only">Home</span>
                            <svg className="h-8" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
